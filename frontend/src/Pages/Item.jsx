                            ...
                            <div className="mb-8 pb-8 border-b border-slate-100">
                                ...
                                <div className="flex items-center gap-5 bg-white p-4 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                                    <img
                                        ...
                                        className="w-16 h-16 rounded-2xl object-cover ring-2 ring-brand-orange/20 shrink-0"
                                    />
                                    <div className="min-w-0 flex-1">
                                        <h3 className="font-bold text-slate-900 text-lg mb-1 truncate">{product.seller?.name}</h3>
