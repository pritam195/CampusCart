...
const Register = () => {
    ...
    const inputClass = "appearance-none block w-full px-4 py-3 border border-slate-200 rounded-xl text-slate-900 bg-slate-50 focus:outline-none focus:ring-2 focus:ring-brand-orange focus:border-brand-orange focus:bg-white transition-all font-medium placeholder:text-slate-400";
                ...
                <div className="bg-white/80 backdrop-blur-xl border border-white p-8 sm:p-10 rounded-3xl shadow-2xl shadow-brand-orange/10">
                    <div className="text-center mb-8">
                        ...
                        <p className="mt-2 text-slate-500 font-medium">
                            ...
                            <Link to="/login" className="font-bold text-brand-orange hover:text-rose-500 transition-colors">
                                Sign in
                            </Link>
                        </p>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={inputClass} placeholder="Your university"
                                />
                            </div>
